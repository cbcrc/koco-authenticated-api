(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'knockout', 'jquery', 'koco-api-utilities', 'lodash', 'koco-url-utilities'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('knockout'), require('jquery'), require('koco-api-utilities'), require('lodash'), require('koco-url-utilities'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.knockout, global.jquery, global.kocoApiUtilities, global.lodash, global.kocoUrlUtilities);
        global.authenticatedApi = mod.exports;
    }
})(this, function (exports, _knockout, _jquery, _kocoApiUtilities, _lodash, _kocoUrlUtilities) {
    'use strict';
